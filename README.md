...
*   Design module `Code/UART-Tx/BaudGenT.v`
*   Test bench `Code/UART-Tx/BaudTest.v`
...
*   Design module `Code/UART-Tx/Parity.v`
*   Test bench `Code/UART-Tx/ParityTest.v`
...
*   Design module `Code/UART-Tx/PISO.v`
*   Test bench `Code/UART-Tx/PisoTest.v`
...
*   Design module `Code/UART-Tx/TxUnit.v`
*   Test bench `Code/UART-Tx/TxTest.v`
...
*   Design module `Code/UART-Rx/BaudGenR.v`
*   Test bench `Code/UART-Rx/BaudTest.v`
...
*   Design module `Code/UART-Rx/SIPO.v`
*   Test bench `Code/UART-Rx/SipoTest.v`
...
*   Design module `Code/UART-Rx/DeFrame.v`
*   Test bench `Code/UART-Rx/DeFrameTest.v`
...
*   Design module `Code/UART-Rx/ErrorCheck.v`
*   Test bench `Code/UART-Rx/CheckTest.v`
...
*   Design module `Code/UART-Rx/RxUnit.v`
*   Test bench `Code/UART-Rx/RxTest.v`
